...
import com.plcoding.musicia.exoplayer.callbacks.MusicPlaybackPreparer
import com.plcoding.musicia.exoplayer.callbacks.MusicPlayerEventListener
import com.plcoding.musicia.exoplayer.callbacks.MusicPlayerNotificationListener
    ...
    override fun onLoadChildren(
        ...
        when(parentId){
            Constants.MEDIA_ROOT_ID -> {
                val resultsSent = firebaseMusicSource.whenReady {isInit ->
                    if(isInit){
